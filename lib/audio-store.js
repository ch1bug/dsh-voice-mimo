 ...
 */
export async function manifestAppend(dir, { id, rel, sessionId = null, callId = null, text = "", voice = "", model = "", notify = false, style = "" }) {
  const entry = {
    id,
    sessionId,
    callId,
 ...
 */
export function planSpeechArtifact({ outPath, audioDir, id, text, voice, model, notify, style = "", sessionId = null, callId = null }) {
  if (outPath) {
