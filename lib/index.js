...
import { applyStyle, resolveTtsTarget, truncateTtsText, DEFAULT_STYLE } from "./tts.js";
import {
  cleanTmp,
  initAudioStore,
  manifestAppend,
  ...
  if (current().tts.enabled) ctx.tools.register(
    defineTool({
      ...
      async execute(args, exec) {
        ...
        const style = (typeof args.style === "string" && args.style.trim()) ? args.style.trim() : (cfg.style || DEFAULT_STYLE);
